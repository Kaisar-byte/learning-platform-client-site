...
const Footer = () => {
	return (
		<footer className="px-4 divide-y bg-[conic-gradient(at_right,_var(--tw-gradient-stops))] from-indigo-200 via-slate-600 to-indigo-200text-gray-100">
			<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
				...
				<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
					...
					<div>
						<div className="mb-2 uppercase dark:text-gray-50">Social media</div>
			...
			<div className="py-6 text-sm text-center dark:text-gray-400">
				© 2022 Programing Zone. All rights reserved.
			</div>
		</footer>
	);
};
